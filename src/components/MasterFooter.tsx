...
export const MasterFooter: React.FC<MasterFooterProps> = ({
  ...
  return (
    <footer className="bg-[#18181B] text-[#FAF7F0] border-t-2 border-[#161616] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        {/* Massive Brand Statement */}
        <div className="border-b border-stone-800 pb-10 mb-10">
          <div className="font-display font-black text-4xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tight text-[#FAF7F0] uppercase leading-none">
            PROUDLY <span className="text-[#D92B8A]">AFRIKAN</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-start mb-12">
          ...
          <div className="md:col-span-6 space-y-4">
            <h4 className="font-mono text-xs font-bold uppercase tracking-widest text-[#D92B8A]">
              ABOUT THIS PLATFORM
            </h4>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2.5 font-mono text-xs font-bold text-stone-200">
              <li>
                <button
                  onClick={() => handleNav('STUDY')}
                  className="hover:text-[#D92B8A] transition-colors cursor-pointer flex items-center gap-1.5 uppercase"
                >
          ...
          <div className="md:col-span-3 space-y-4 flex flex-col items-start md:items-end">
            <button
              ...
              className="px-5 py-3 bg-[#D92B8A] hover:bg-[#c02479] text-white font-mono font-bold text-xs uppercase tracking-wider rounded-xl shadow-md flex items-center gap-2 cursor-pointer transition-all active:scale-95 border border-pink-400/30"
            >
              <span>BACK TO TOP</span>
              <ArrowUp className="w-4 h-4" />
            </button>
            <div className="font-mono text-[11px] text-stone-500 space-y-1 text-left md:text-right">
              <div>VERSION 1.0 • 2026</div>
              <div className="text-stone-400">CAPS & IEB ALIGNED</div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-stone-800 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-stone-400 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="text-[#D92B8A] hover:underline font-bold transition-colors"
            >
