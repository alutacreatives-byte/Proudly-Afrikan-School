    ...
    <section className="pt-2 pb-8 border-b border-stone-200/80">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-6 flex flex-col justify-start">
          {/* Edition Pill Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 clay-pill-3d text-[10px] sm:text-xs font-mono font-bold tracking-wider uppercase text-stone-800 self-start h-8 whitespace-nowrap">
            <span className="w-2 h-2 rounded-full bg-[#FF7A00] inline-block animate-pulse shadow-[0_0_6px_rgba(255,128,0,0.6)] shrink-0"></span>
          ...
          <h1 className="font-display font-black text-5xl sm:text-7xl md:text-8xl lg:text-[5.5rem] xl:text-[6.25rem] uppercase tracking-tighter text-[#161616] leading-[0.88] sm:leading-[0.9] lg:leading-[0.92] break-words">
            BUILD<br />
            LESSONS.<br />
            <span className="bg-gradient-to-r from-[#FF7A00] via-[#D09500] to-[#A67A00] bg-clip-text text-transparent">TEACH<br />CLEARLY.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-2">
            <button
              ...
              className="w-full sm:w-auto px-7 sm:px-8 py-4 bg-gradient-to-r from-[#FF7A00] via-[#D48800] to-[#A67A00] hover:brightness-105 text-white font-display text-xs sm:text-sm font-black uppercase tracking-wider flex items-center justify-center gap-2.5 cursor-pointer rounded-2xl shadow-[0_6px_20px_rgba(255,128,0,0.4)]"
            >
