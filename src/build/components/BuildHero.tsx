        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-2">
            <button
              ...
              className="w-full sm:w-auto px-7 sm:px-8 py-4 bg-[#E63956] hover:bg-[#d02e49] text-white font-display text-xs sm:text-sm font-black uppercase tracking-wider rounded-full shadow-[0_4px_18px_rgba(230,57,86,0.38)] transition-all flex items-center justify-center gap-2.5 active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-7 sm:px-8 py-4 bg-[#161616] hover:bg-stone-800 text-white font-display text-xs sm:text-sm font-black uppercase tracking-wider rounded-full shadow-md transition-all flex items-center justify-center gap-2.5 active:scale-95 cursor-pointer"
            >
              ...
              {inspirationTopics.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="px-3.5 py-2.5 bg-white hover:bg-pink-50/60 border border-stone-200/90 hover:border-pink-300 text-stone-800 hover:text-[#E63956] font-medium text-xs sm:text-sm rounded-full transition-all shadow-sm flex items-center gap-2 text-left truncate cursor-pointer"
                  >
