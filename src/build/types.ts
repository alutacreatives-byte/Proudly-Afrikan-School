...
export interface StudyGuideSavedResource {
  id: string;
  title: string;
  subject?: string;
  topic?: string;
...
export interface FlashcardsSavedResource {
  id: string;
  title: string;
  subject?: string;
  topic?: string;
...
export interface PracticeQuizSavedResource {
  id: string;
  title: string;
  subject?: string;
  topic?: string;
  gradeLevel?: string;
  createdAt?: string;
  toolType: 'quiz' | 'study-quiz';
  data?: any;
  [key: string]: any;
}

export interface SearchResultSavedResource {
  id: string;
  title: string;
  subject?: string;
  topic?: string;
...
export interface GenericSavedResource {
  id: string;
  title: string;
  subject?: string;
  topic?: string;
...
// Compatibility aliases for services
...
export type SavedResource<T = any> =
  ...
  | StudyPackResource
  | PdfQuizBuildResult
  | StudyGuideSavedResource
  | FlashcardsSavedResource
  | PracticeQuizSavedResource
  | SearchResultSavedResource
  | GenericSavedResource
  | T;
